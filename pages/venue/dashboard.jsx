  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-neutral-950 text-neutral-100 relative overflow-x-hidden">
        ...
        {venue.logo_url && (
          <div className="fixed left-0 top-1/2 -translate-y-1/2 translate-x-0 w-150 h-150 pointer-events-none z-0 select-none">
            <img
              src={venue.logo_url}
              alt=""
        ...
        <header className="border-b border-neutral-800 bg-neutral-950/80 backdrop-blur sticky top-0 z-50">
          <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
            <div className="flex items-center gap-3">
              {venue.logo_url ? (
                <img src={venue.logo_url} alt={venue.name} className="h-10 w-auto object-contain" />
              ) : (
